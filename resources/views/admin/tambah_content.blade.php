...
<div class="card border-0 shadow-sm rounded-3">
    ...
    <div class="card-body p-4">
        ...
        <form action="{{ route('admin.content.store', $section) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title"
                       ...
                       value="{{ old('title') }}"
                       placeholder="cth. Surat Keterangan Domisili" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="excerpt" class="form-control" rows="2"
                          placeholder="cth. Surat keterangan tempat tinggal resmi dari desa">{{ old('excerpt') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <textarea name="body" class="form-control" rows="4"
                          placeholder="KTP, Kartu Keluarga, Surat Pengantar RT/RW">{{ old('body') }}</textarea>
                <div class="form-text">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="title"
                       class="form-control @error('title') is-invalid @enderror"
                       value="{{ old('title') }}" placeholder="cth. Peraturan Desa No. 1 Tahun 2025" required>
                @error('title')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="category" class="form-control"
                           value="{{ old('category') }}" placeholder="cth. Peraturan Desa">
                </div>
                <div class="col-md-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="excerpt" class="form-control" rows="2"
                          placeholder="Deskripsi singkat isi dokumen...">{{ old('excerpt') }}</textarea>
            </div>

            <div class="mb-3">
                <label class="form-label fw-semibold" style="color:var(--color-7);">Link Dokumen <small class="text-muted fw-normal">(URL eksternal, opsional)</small></label>
                <input type="url" name="link" class="form-control"
                       value="{{ old('link') }}" placeholder="https://...">
            </div>

            <div class="mb-4">
                <label class="form-label fw-semibold" style="color:var(--color-7);">Upload File <small class="text-muted fw-normal">(PDF, Word, Excel – maks. 10MB)</small></label>
                <input type="file" name="file" class="form-control" accept=".pdf,.doc,.docx,.xls,.xlsx">
                <div class="form-text">Jika diisi, file akan diutamakan daripada link.</div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="excerpt" class="form-control" rows="2"
                          placeholder="Deskripsi singkat...">{{ old('excerpt') }}</textarea>
            </div>

            <div class="mb-3">
                <label class="form-label fw-semibold" style="color:var(--color-7);">Isi Konten</label>
                <textarea name="body" class="form-control" rows="5"
                          placeholder="Isi lengkap...">{{ old('body') }}</textarea>
            </div>
